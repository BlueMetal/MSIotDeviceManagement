                ...
                new OpenIdConnectAuthenticationOptions
                {
                    ...
                    Notifications = new OpenIdConnectAuthenticationNotifications()
                    {
                        ...
                        AuthorizationCodeReceived = async (context) =>
                        {
                            ...
                            try
                            {
                                var authenticationContext = new AuthenticationContext(AuthConfig.ConfigurationItems.AADInstance + AuthConfig.SessionItems.GraphTargetTenant);
                                var credential = new ClientCredential(AuthConfig.ConfigurationItems.ClientId,
                                    AuthConfig.ConfigurationItems.AppKey);
