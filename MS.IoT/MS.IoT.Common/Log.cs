...
using BaseLog = Serilog.Log;

namespace MS.IoT.Common
{
    /// <summary>
    ...
    public static class Log
    {
        ...
        public static void Init(string appinsightkey)
        {
            BaseLog.Logger = new LoggerConfiguration()
                    .WriteTo
                    .ApplicationInsightsTraces(appinsightkey)
                    .CreateLogger();
        }
        ...
        {
            return BaseLog.ForContext(enricher);
        }
        ...
        {
            return BaseLog.ForContext(enrichers);
        }
        ...
        {
            return BaseLog.ForContext(propertyName, value, destructureObjects);
        }
        ...
        {
            return BaseLog.ForContext<TSource>();
        }
        ...
        {
            return BaseLog.ForContext(source);
        }
        ...
        {
            BaseLog.Write(level, messageTemplate);
        }
        ...
        {
            BaseLog.Write(level, messageTemplate, propertyValue);
        }
        ...
        {
            BaseLog.Write(level, messageTemplate, propertyValue0, propertyValue1);
        }
        ...
        {
            BaseLog.Write(level, messageTemplate, propertyValue0, propertyValue1, propertyValue2);
        }
        ...
        {
            BaseLog.Write(level, messageTemplate, propertyValues);
        }
        ...
        {
            BaseLog.Write(level, exception, messageTemplate);
        }
        ...
        {
            BaseLog.Write(level, exception, messageTemplate, propertyValue);
        }
        ...
        {
            BaseLog.Write(level, exception, messageTemplate, propertyValue0, propertyValue1);
        }
        ...
        {
            BaseLog.Write(level, exception, messageTemplate, propertyValue0, propertyValue1, propertyValue2);
        }
        ...
        {
            BaseLog.Write(level, exception, messageTemplate, propertyValues);
        }
        ...
        {
            return BaseLog.IsEnabled(level);
        }
        ...
        {
            BaseLog.Verbose(messageTemplate, propertyValues);
        }
        ...
        {
            BaseLog.Verbose(exception, messageTemplate, propertyValues);
        }
        ...
        {
            BaseLog.Debug(messageTemplate, propertyValues);
        }
        ...
        {
            BaseLog.Debug(exception, messageTemplate, propertyValues);
        }
        ...
        {
            BaseLog.Information(messageTemplate, propertyValues);
        }
        ...
        {
            BaseLog.Information(exception, messageTemplate, propertyValues);
        }
        ...
        {
            BaseLog.Warning(messageTemplate, propertyValues);
        }
        ...
        {
            BaseLog.Warning(exception, messageTemplate, propertyValues);
        }
        ...
        {
            BaseLog.Error(messageTemplate, propertyValues);
        }
        ...
        {
            BaseLog.Error(exception, messageTemplate, propertyValues);
        }
        ...
        {
            BaseLog.Fatal(messageTemplate, propertyValues);
        }
        ...
        {
            BaseLog.Fatal(exception, messageTemplate, propertyValues);
        }
        ...
        {
            return BaseLog.BindMessageTemplate(messageTemplate, propertyValues, out parsedTemplate, out boundProperties);
        }
    }
}
