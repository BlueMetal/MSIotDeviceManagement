...
set _DeploySetParametersFile=%RootPath%MS.IoT.DeviceManagementPortal.Web.SetParameters.xml
)
...
@rem ---------------------------------------------------------------------------------
if not exist "%RootPath%MS.IoT.DeviceManagementPortal.Web.zip" (
echo "%RootPath%MS.IoT.DeviceManagementPortal.Web.zip" does not exist. 
...
set _MSDeployCommandline="%MSDeployPath%msdeploy.exe" -source:package='%RootPath%MS.IoT.DeviceManagementPortal.Web.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension
) else (
set _MSDeployCommandline="%MSDeployPath%msdeploy.exe" -source:package='%RootPath%MS.IoT.DeviceManagementPortal.Web.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension -setParamFile:"%_DeploySetParametersFile%"
)
...
:usage
echo =========================================================
if not exist "%RootPath%MS.IoT.DeviceManagementPortal.Web.deploy-readme.txt" (
...
start notepad "%RootPath%MS.IoT.DeviceManagementPortal.Web.deploy-readme.txt"
)
echo =========================================================
goto :eof
