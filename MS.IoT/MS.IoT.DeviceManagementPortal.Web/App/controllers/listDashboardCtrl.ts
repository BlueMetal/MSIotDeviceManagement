module MSIoTDeviceManagementPortal {
	...
	class ListDashboardCtrl {
        ...
        private deviceTwinSummary: DeviceTwinSummary;
        ...
        constructor(alerts: Alert[], deviceDBService: IDeviceDBService, $uibModal: ng.ui.bootstrap.IModalService,
            ...
            let fieldStatus: DatatableField = { name: "connectionStatus", displayName: "Status", class: "col-md-1", rendering: this.renderStatus };
            ...
            this.dbConfig = {
                ...
                tabs: [
                    { title: 'All', groupBy: null, fields: [fieldProductFamily, fieldProductName, fieldRetailerName, fieldRetailerLocation, fieldLocation, fieldStatus, fieldCode], orderByDefault: '', orderBySortingDefault: OrderByType.Ascending },
                    ...
                    { title: 'Status', groupBy: 'connectionStatus', fields: [fieldStatus, fieldProductFamily, fieldProductName, fieldRetailerName, fieldRetailerLocation, fieldLocation, fieldCode], orderByDefault: 'connectionStatus', orderBySortingDefault: OrderByType.Ascending, rendering: this.renderStatus },
                ]
            };
