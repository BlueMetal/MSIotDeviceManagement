module MSIoTDeviceManagementPortal {
	...
	class UpdatePropertiesModalCtrl {
        ...
        public isUpdateClicked: boolean;
        ...
        public addSubProperty(desiredField) {
            desiredField.children.push({});
        }

        public removeProperty(desiredField, subProperty) {
    ...
    app.controller('UpdatePropertiesModalCtrl', UpdatePropertiesModalCtrl as any);
}
