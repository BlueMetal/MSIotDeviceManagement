module MSIoTDeviceManagementPortal {
    ...
    class MapDashboardCtrl {
        static $inject: Array<string> = ['currentUser', 'DeviceDBService', '$timeout', '$sce'];
        ...
        //Main Constructor
        constructor(currentUser: User, deviceDBService: IDeviceDBService, $timeout:any, $sce : ng.ISCEService) {
            ...
            this.deviceDBService.getMapGroupsInformations().then((response: DeviceMapGroupsInformation) => {
                ...
                Microsoft.Maps.loadModule('Microsoft.Maps.SpatialDataService', () => {
                    ...
                    Microsoft.Maps.loadModule("Microsoft.Maps.Clustering", () => {
                        ...
                        this.mapState = {
                            initialized: false,
                            currentZoom: this.mapConfig.initConfig.zoom,
        ...
        private refreshAreasInternal(query: DeviceMapQueryConfiguration) {
            ...
            this.deviceDBService.getDevicesTwinMapArea(query).then((response: DeviceMapAreaQueryResponse) => {
                var areaItems: any[] = response.areaItems;
                var areaGroups: string[] = [];
                var totalDevicesShipped: number = 0;

                var minValue : number = -1;
                var maxValue: number = -1;

                var colorSystem: ColorsAreasConfig[] = null;
        ...
        private getCurrentAreaConfig(): ZoomAreaConfig {
        ...
        private eventViewChanged(e, c: MapDashboardCtrl) {
