module MSIoTDeviceManagementPortal {
    ...
    export type MapFiltersState = {
        ...
        filterActivationDateMin: moment.MomentDateObject;
        filterActivationDateMax: moment.MomentDateObject;
        filterShippingDateMin: moment.MomentDateObject;
        filterShippingDateMax: moment.MomentDateObject;
