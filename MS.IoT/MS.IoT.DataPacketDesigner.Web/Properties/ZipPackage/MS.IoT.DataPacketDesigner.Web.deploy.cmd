...
set _DeploySetParametersFile=%RootPath%MS.IoT.DataPacketDesigner.Web.SetParameters.xml
)
...
@rem ---------------------------------------------------------------------------------
if not exist "%RootPath%MS.IoT.DataPacketDesigner.Web.zip" (
echo "%RootPath%MS.IoT.DataPacketDesigner.Web.zip" does not exist. 
...
set _MSDeployCommandline="%MSDeployPath%msdeploy.exe" -source:package='%RootPath%MS.IoT.DataPacketDesigner.Web.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension
) else (
set _MSDeployCommandline="%MSDeployPath%msdeploy.exe" -source:package='%RootPath%MS.IoT.DataPacketDesigner.Web.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension -setParamFile:"%_DeploySetParametersFile%"
)
...
:usage
echo =========================================================
if not exist "%RootPath%MS.IoT.DataPacketDesigner.Web.deploy-readme.txt" (
...
start notepad "%RootPath%MS.IoT.DataPacketDesigner.Web.deploy-readme.txt"
)
echo =========================================================
goto :eof
