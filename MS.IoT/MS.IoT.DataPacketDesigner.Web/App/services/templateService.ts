module msIoT {
    ...
    export class TemplateService implements ITemplateService {
        ...
        private cacheCommonTemplates: Template[];
        private cacheCategories: Category[];
        private cacheUserTemplates: Template[];
        ...
        public getCommonTemplates(): ng.IPromise<Template[]> {
            ...
            if (this.cacheCommonTemplates)
                ...
                this.$http({
                    ...
                    this.cacheCommonTemplates = response.data;
        ...
        public getUserTemplates(): ng.IPromise<Template[]> {
            ...
            if (this.cacheUserTemplates)
                ...
                this.$http({
                    ...
                    this.cacheUserTemplates = response.data;
                    deferred.resolve(response.data);
        ...
        public getCategories(): ng.IPromise<Category[]> {
            ...
            if (this.cacheCategories)
                ...
                this.$http({
                    ...
                    this.cacheCategories = response.data;
                    deferred.resolve(response.data);
